...
class FAssetEditor_Dialogue : public FAssetEditorToolkit, public FNotifyHook, public FGCObject
{
public:
	FAssetEditor_Dialogue();
	virtual ~FAssetEditor_Dialogue();

	void InitDialogueAssetEditor(const EToolkitMode::Type Mode, const TSharedPtr< IToolkitHost >& InitToolkitHost, UDialogueSession* Graph);
	...
	//Toolbar
	void UpdateToolbar();
	TSharedPtr<class FAssetEditorToolbar_Dialogue> GetToolbarBuilder() { return ToolbarBuilder; }
...
protected:
	UDialogueEditorSettings* DialogueEditorSettings;

	UDialogueSession* EditingGraph;
